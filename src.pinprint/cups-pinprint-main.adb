...
begin
   ...
   --if Integer'Value(Printer_State) < 3 then
         ...
         Num_Options := Cups.AddOption ("raw", "true", Num_Options, Options'Address);
         Num_Options := Cups.AddOption ("usb-no-reattach-default", "true", Num_Options, Options'Address);
