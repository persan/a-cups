...
private package CUPS.stdio_h is
  ...
  -- The opaque type of streams.  This is the definition used elsewhere.   
   subtype FILE is CUPS.libio_h.u_IO_FILE;

  -- The opaque type of streams.  This is the definition used elsewhere.   
   subtype uu_FILE is CUPS.libio_h.u_IO_FILE;

   subtype va_list is CUPS.stdarg_h.uu_gnuc_va_list;  -- stdio.h:79

   subtype off_t is CUPS.bits_types_h.uu_off_t;  -- stdio.h:90

   subtype off64_t is CUPS.bits_types_h.uu_off64_t;  -- stdio.h:97

   subtype ssize_t is CUPS.bits_types_h.uu_ssize_t;  -- stdio.h:102

  -- The type of the second argument to `fgetpos' and `fsetpos'.   
   subtype fpos_t is CUPS.uG_config_h.u_G_fpos_t;

   subtype fpos64_t is CUPS.uG_config_h.u_G_fpos64_t;
  ...
  -- Standard input stream.   
   stdin : access CUPS.libio_h.u_IO_FILE;  -- stdio.h:168
   pragma Import (C, stdin, "stdin");

  -- Standard output stream.   
   stdout : access CUPS.libio_h.u_IO_FILE;  -- stdio.h:169
   pragma Import (C, stdout, "stdout");

  -- Standard error output stream.   
   stderr : access CUPS.libio_h.u_IO_FILE;  -- stdio.h:170
  ...
  --   and uses the given functions for input and output.   
   ...
   function fopencookie
     (uu_magic_cookie : System.Address;
      uu_modes : Interfaces.C.Strings.chars_ptr;
      uu_io_funcs : CUPS.libio_h.u_IO_cookie_io_functions_t) return access FILE;  -- stdio.h:312
  ...
  --   therefore not marked with __THROW.   
   ...
   function getdelim
     (uu_lineptr : System.Address;
      uu_n : access size_t;
      uu_delimiter : int;
      uu_stream : access FILE) return CUPS.bits_types_h.uu_ssize_t;  -- stdio.h:668
  ...
  --   therefore not marked with __THROW.   
   ...
   function getline
     (uu_lineptr : System.Address;
      uu_n : access size_t;
      uu_stream : access FILE) return CUPS.bits_types_h.uu_ssize_t;  -- stdio.h:678
  ...
  --   marked with __THROW.   
   ...
   function fseeko
     (uu_stream : access FILE;
      uu_off : CUPS.bits_types_h.uu_off_t;
  ...
  --   marked with __THROW.   
   ...
   function ftello (uu_stream : access FILE) return CUPS.bits_types_h.uu_off_t;  -- stdio.h:778
  ...
  --   marked with __THROW.   
   ...
   function fseeko64
     (uu_stream : access FILE;
      uu_off : CUPS.bits_types_h.uu_off64_t;
      uu_whence : int) return int;  -- stdio.h:818
   pragma Import (C, fseeko64, "fseeko64");

   function ftello64 (uu_stream : access FILE) return CUPS.bits_types_h.uu_off64_t;  -- stdio.h:819
