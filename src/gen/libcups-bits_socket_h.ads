...
package libCUPS.bits_socket_h is
  ...
  -- PID of sending process.
   type ucred is record
      pid : aliased libCUPS.sys_types_h.pid_t;  -- bits/socket.h:317
      uid : aliased libCUPS.sys_types_h.uid_t;  -- bits/socket.h:318
      gid : aliased libCUPS.sys_types_h.gid_t;  -- bits/socket.h:319
   end record;
