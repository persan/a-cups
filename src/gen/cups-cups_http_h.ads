...
with CUPS.netinet_in_h;
with CUPS.sys_un_h;
with System;

with Interfaces.C.Strings;
with CUPS.time_h;
limited with CUPS.netdb_h;
with CUPS.stdio_h;
...
package CUPS.cups_http_h is
  ...
  -- Base structure for family value  
   ...
   type u_http_addr_u (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            addr : aliased CUPS.bits_socket_h.sockaddr;  -- cups/http.h:417
         when 1 =>
            ipv4 : aliased CUPS.netinet_in_h.sockaddr_in;  -- cups/http.h:418
         when 2 =>
            ipv6 : aliased CUPS.netinet_in_h.sockaddr_in6;  -- cups/http.h:420
         when 3 =>
            un : aliased CUPS.sys_un_h.sockaddr_un;  -- cups/http.h:423
         when others =>
  ...
  --  
   ...
   function httpGetDateString (t : CUPS.time_h.time_t) return Interfaces.C.Strings.chars_ptr;  -- cups/http.h:470
   pragma Import (C, httpGetDateString, "httpGetDateString");

   function httpGetDateTime (s : Interfaces.C.Strings.chars_ptr) return CUPS.time_h.time_t;  -- cups/http.h:471
   ...
   function httpGetHostByName (name : Interfaces.C.Strings.chars_ptr) return access CUPS.netdb_h.hostent;  -- cups/http.h:473
  ...
  --*** New in CUPS 1.2/OS X 10.5 *** 
   ...
   function httpGetLength2 (http : System.Address) return CUPS.stdio_h.off_t;  -- cups/http.h:550
  ...
  -- New in CUPS 2.0/OS X 10.10  
   ...
   function httpCredentialsGetExpiration (credentials : System.Address) return CUPS.time_h.time_t;  -- cups/http.h:628
   ...
   function httpGetActivity (http : System.Address) return CUPS.time_h.time_t;  -- cups/http.h:632
