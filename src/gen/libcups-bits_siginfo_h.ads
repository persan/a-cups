...
with System;
limited with libCUPS.bits_pthreadtypes_h;
with libCUPS.bits_types_h;

package libCUPS.bits_siginfo_h is
  ...
  -- Forward declaration.   
   ...
   type anon_34 is record
      ...
      u_attribute : access libCUPS.bits_pthreadtypes_h.pthread_attr_t;  -- bits/siginfo.h:337
   end record;
   ...
   type anon_33 (discr : unsigned := 0) is record
      case discr is
         ...
         when 1 =>
            u_tid : aliased libCUPS.bits_types_h.uu_pid_t;  -- bits/siginfo.h:332
         when others =>
