...
package CUPS.bits_socket_h is
  ...
  -- Common data: address family and length.
   ...
   type sockaddr is record
      sa_family : aliased CUPS.bits_sockaddr_h.sa_family_t;  -- bits/socket.h:155
      sa_data : aliased sockaddr_sa_data_array;  -- bits/socket.h:156
   end record;
  ...
  -- Address to send to/receive from.
   type msghdr is record
      ...
      msg_namelen : aliased CUPS.unistd_h.socklen_t;  -- bits/socket.h:231
      msg_iov : access CUPS.bits_uio_h.iovec;  -- bits/socket.h:233
  ...
  --				   with this.
   ...
   type cmsghdr is record
      ...
      uu_cmsg_data : aliased cmsghdr_uu_cmsg_data_array;  -- bits/socket.h:256
   end record;
  ...
  -- PID of sending process.
   type ucred is record
      pid : aliased CUPS.sys_types_h.pid_t;  -- bits/socket.h:317
      uid : aliased CUPS.sys_types_h.uid_t;  -- bits/socket.h:318
      gid : aliased CUPS.sys_types_h.gid_t;  -- bits/socket.h:319
   end record;
   pragma Convention (C_Pass_By_Copy, ucred);  -- bits/socket.h:315
