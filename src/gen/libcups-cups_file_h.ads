...
package libCUPS.cups_file_h is
  ...
  --  
   ...
   function cupsFileRewind (fp : System.Address) return libCUPS.stdio_h.off_t;  -- cups/file.h:100
   pragma Import (C, cupsFileRewind, "cupsFileRewind");

   function cupsFileSeek (fp : System.Address; pos : libCUPS.stdio_h.off_t) return libCUPS.stdio_h.off_t;  -- cups/file.h:101
   ...
   function cupsFileTell (fp : System.Address) return libCUPS.stdio_h.off_t;  -- cups/file.h:105
