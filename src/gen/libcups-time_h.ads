...
package libCUPS.time_h is
  ...
  --   the provided locale and not the global locale.   
   ...
   function strftime_l
     (uu_s : Interfaces.C.Strings.chars_ptr;
      ...
      uu_loc : libCUPS.xlocale_h.uu_locale_t) return size_t;  -- time.h:223
   ...
   function strptime_l
     (uu_s : Interfaces.C.Strings.chars_ptr;
      uu_fmt : Interfaces.C.Strings.chars_ptr;
      uu_tp : access tm;
      uu_loc : libCUPS.xlocale_h.uu_locale_t) return Interfaces.C.Strings.chars_ptr;  -- time.h:230
  ...
  -- Return clock ID for CPU-time clock.   
   function clock_getcpuclockid (uu_pid : libCUPS.sys_types_h.pid_t; uu_clock_id : access clockid_t) return int;  -- time.h:358
   pragma Import (C, clock_getcpuclockid, "clock_getcpuclockid");

  -- Create new per-process timer using CLOCK_ID.   
   function timer_create
     (uu_clock_id : clockid_t;
      uu_evp : access libCUPS.bits_siginfo_h.sigevent;
